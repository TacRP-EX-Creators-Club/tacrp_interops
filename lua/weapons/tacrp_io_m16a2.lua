...
SWEP.PostBurstDelay = 0.18

SWEP.RPM = 700
SWEP.RPMMultBurst = 850 / 700
...
SWEP.SightAng = Angle(0.15, -0.2, 0)
SWEP.SightPos = Vector(-4.17, -7.5, -4.13)
...
local path1 = "tacint_extras/m16a2/"
...
SWEP.Attachments = {
    ...
    [2] = {
        ...
        Pos_VM = Vector(-3.85, 0, 30.5),
        Pos_WM = Vector(1.7, 28, -1),
        Ang_VM = Angle(90, 0, 0),
        Ang_WM = Angle(0, -90 + 3.5, 0),
    },
    [3] = {
...
addsound("tacint_extras_m16a2.Remove_Clip", path1 .. "magout.wav")
addsound("tacint_extras_m16a2.Insert_Clip", path1 .. "magin.wav")
addsound("tacint_extras_m16a2.Insert_Clip-mid", path1 .. "magin2.wav")
addsound("tacint_extras_m16a2.bolt_action", path .. "bolt_action.wav")
addsound("tacint_extras_m16a2.bolt_slap", path .. "bolt_slap.wav")
addsound("tacint_extras_m16a2.throw_catch", path .. "throw_catch.wav")